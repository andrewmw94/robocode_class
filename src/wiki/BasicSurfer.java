...
public class BasicSurfer extends AdvancedRobot {
    ...
    public void onScannedRobot(ScannedRobotEvent e) {
        ...
        if (bulletPower < 3.01 && bulletPower > 0.09
            ...
            ew.our_distance = Point2D.Double.distance(_myLocation.x, _myLocation.y, _enemyLocation.x, _enemyLocation.y);
            ew.our_velocity = getVelocity();
            ew.our_acceleration = our_last_velocity - getVelocity();
    ...
    public void logHit(EnemyWave ew, Point2D.Double targetLocation) {
        ...
        for (int x = 0; x < BINS; x++) {
            ...
            coordinates[0] = ew.our_distance;
            coordinates[1] = ew.our_velocity;
            coordinates[2] = ew.our_acceleration;

            double[] data = new double[1];
            data[0] = getFactor(ew, targetLocation);
    ...
    public double checkDanger(EnemyWave surfWave, int direction) {
        ...
        double factor = getFactor(surfWave, predictPosition(surfWave, direction));
        double[] coordinates = new double[NUM_DIMENSIONS_FOR_KDTREE];
